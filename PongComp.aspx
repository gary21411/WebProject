<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PongComp.aspx.cs" Inherits="WebProj.PongComp" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Pong (comp)</title>
        ...
        <div>
            <canvas id="screen" width="800" height="480"></canvas>
                <script>
                    ...
                    function MoveBotAI() {
                        if ((P2y < (ZeeCanvas.height - 100)) && (P2y >= -4)) { // so that P2 won't die (the big ifs)
                            if (bally > P2y) { P2y += 9; }
                            if (bally < P2y) { P2y -= 9; }
                        }
                        else if (P2y <= -5) { P2y += 1; }
                    ...
                    function moveAll() {
                        ...
                        if (bally >= ZeeCanvas.height - 10) { yv = -yv } // if bottom wall hit
